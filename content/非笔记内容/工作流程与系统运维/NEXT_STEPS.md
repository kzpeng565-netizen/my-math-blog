...
==概率论教材已更正为 Le Gall 主教材、Durrett 参考书。当前先按目标模式 ready 顺序执行：08-31 收尾 GTM259 §2.1，09-01 学 §2.2 Recurrence，09-02 复习测度与可测映射，09-03 做 §2.2 习题/证明复述，09-04 复习积分与收敛。任何课程上课后仍要记录真实小节、0–3 掌握度和依据；课内任务随后接管。考试日期仍未知。==

### ☐ 补充数学所、遍历论范围与抽象代数题源

==数学所仍需至少三份可区分真实题源；GTM259 的近期入口已具体到 §2.1–2.2，但 2027-01-31 前双方确认章节范围仍待补充；抽象代数仍需书面题组和口头题库。缺少长期范围不阻塞本周启动任务。==
