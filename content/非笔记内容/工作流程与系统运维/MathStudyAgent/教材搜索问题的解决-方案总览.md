...
### ==长期方案 3：主 Tutor 受控申请补充检索==

==在 v1.5 稳定并积累评测数据后，可以向 GPT-5.5 high 暴露受控教材搜索工具，使主 Tutor 在回答过程中最多申请一次白名单补充检索。它不能绕过程序维护的证据等级、对象预算、教材范围和失败返回规则，也不取代 v1.5 的初始查询理解链路。==

<!-- ai_provenance: source=codex; date=2026-08-11; verification=user-confirmed; retrieved_notes="教材搜索问题的解决-方案总览.md" -->
