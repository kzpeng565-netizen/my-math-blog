...
## UCAS roaming and Windows hotspot failover

Read:

```text
references/wifi-failover.md
manage-pi-server/references/server-layout.md
树莓派UCAS无线漫游与电脑热点自动回退.md
PI_SERVER_HANDOFF.md
```

Use for: intermittent Pi-only Tailnet loss, UCAS BSSID roaming, `wifi-failover.timer`, dual-stack probe thresholds, `XYH 0563`, computer-away behavior, Windows hotspot scripts, and the touch-panel `一键恢复热点连接` button.
