...
class CleaningTests(unittest.TestCase):
    ...
    def test_xianyu_is_locked_as_shopping(self):
        tagged = self._single_computer_tagged_fact(
            "闲鱼 - 发现更多好物",
            "2.taobao.com",
        )
        report = next(block for block in tagged["blocks"] if block["scope"] == "report")
        self.assertIn("shopping_app", {tag["name"] for tag in report["tags"]})
        self.assertEqual(report["locked_activity"], "shopping")
        self.assertTrue(report["force_boundary"])
    ...
    def test_entertainment_over_thirty_seconds_inside_work_is_deviation(self):
        ...
        self.assertEqual(result["qualified_work_entertainment_transition_count"], 2)

    def test_shopping_inside_work_is_not_entertainment_deviation(self):
        semantic = {
            "segments": [
                {
                    "start": "2026-08-07T22:30:00+08:00",
                    "end": "2026-08-07T22:45:00+08:00",
                    "duration_seconds": 900,
                    "activity": "work",
                },
                {
                    "start": "2026-08-07T22:45:00+08:00",
                    "end": "2026-08-07T22:49:00+08:00",
                    "duration_seconds": 240,
                    "activity": "shopping",
                    "relationship_to_work": "standalone_activity",
                    "task": "在闲鱼浏览商品",
                    "evidence": ["com.taobao.idlefish"],
                    "confidence": "high",
                },
                {
                    "start": "2026-08-07T22:49:00+08:00",
        ...
        result = calculate_work_entertainment_mixing(
            semantic,
            {"computer_fragmentation_metrics": {"context_switch_count": 2, "context_blocks": []}},
            {"timezone": "Asia/Shanghai", "state_rules": {"entertainment_deviation_minimum_seconds": 30}},
        )
        self.assertEqual(result["entertainment_deviation_count"], 0)
        self.assertEqual(result["work_entertainment_transition_count"], 0)
        self.assertEqual(result["qualified_work_entertainment_transition_count"], 0)

    def test_short_work_does_not_count_as_an_alternation_bridge(self):
        semantic = {
            "segments": [
                {"start": "2026-08-02T09:33:54+08:00", "end": "2026-08-02T09:34:35+08:00", "duration_seconds": 41, "activity": "entertainment", "relationship_to_work": "entertainment_detour"},
                {"start": "2026-08-02T09:34:35+08:00", "end": "2026-08-02T09:34:46+08:00", "duration_seconds": 11, "activity": "work"},
                {"start": "2026-08-02T09:34:46+08:00", "end": "2026-08-02T09:35:50+08:00", "duration_seconds": 64, "activity": "entertainment", "relationship_to_work": "entertainment_detour"},
                {"start": "2026-08-02T09:35:50+08:00", "end": "2026-08-02T09:40:50+08:00", "duration_seconds": 300, "activity": "work"},
            ]
        }
        result = calculate_work_entertainment_mixing(
            semantic,
            {"computer_fragmentation_metrics": {"context_switch_count": 0, "context_blocks": []}},
            {
                "timezone": "Asia/Shanghai",
                "state_rules": {
                    "entertainment_deviation_minimum_seconds": 30,
                    "work_entertainment_minimum_work_bridge_seconds": 60,
                },
            },
        )
        self.assertEqual(result["entertainment_deviation_count"], 2)
        self.assertEqual(result["qualified_work_entertainment_transition_count"], 1)
        self.assertEqual(
            result["rule"]["work_entertainment_minimum_work_bridge_seconds"], 60
        )
