...
- `locked_markers`是程序已确定为通信、娱乐或休息的正式时段，没有可输出ID。
...
5. 不同软件可以属于同一任务，但通信、娱乐、休息或不确定性不能藏入工作组。
...

{
  ...
  "groups": [
    {
      "block_ids": ["r012", "r013"],
      "activity": "work|entertainment|brief_communication|other|uncertain",
