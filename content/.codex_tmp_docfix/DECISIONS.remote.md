...
### D80. 手机介入采用锁屏等待与 10 秒原生选择页【有效】

offer 生命周期由 Android 前台服务管理：锁屏最多等待 2 分钟，解锁后给出完整 10 秒接受/拒绝窗口；重新锁屏撤页并恢复等待；超时为 ignored。决定先持久化再提交，Automate 和“不做手机控”不承担桥接唤醒与后台存活。
