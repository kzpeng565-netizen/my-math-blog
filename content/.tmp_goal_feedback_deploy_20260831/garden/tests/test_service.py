...
class GardenServiceTests(unittest.TestCase):
    ...
    def test_goal_mode_exposes_course_progress_and_gpt_sol_without_deepseek_fallback(self):
        ...
        self.assertIn('id="goalFeedbackType"', page)
        self.assertIn('value="course"', page)
        self.assertIn('value="mock"', page)
        self.assertIn('id="goalQuickFields"', page)
        self.assertIn('id="goalEvidenceBoundary"', page)
        ...
        self.assertIn("assistance:goalQuickChoices.assistance", script)
        self.assertIn("goalTrackForKind", script)
        self.assertIn("不回退到 DeepSeek", script)
        self.assertIn("awaiting_course_progress", script)
        self.assertIn(".goal-quick-fields", styles)
        self.assertIn(".goal-feedback-action", styles)
