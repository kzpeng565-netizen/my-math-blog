...
import type { StrokeStyleSnapshotV1, Tool } from "./stroke-style";

export type { Tool } from "./stroke-style";
...
export interface Stroke {
  ...
  size: number;
  tool: Tool;
  /** Immutable visual settings captured when the stroke was committed (schema v2+). */
