...
export interface InkedMarkSettings {
  ...
  debugHud: boolean;
  inputLabDeviceModel: string;
  inputLabStylus: string;
  inputLabOperatingSystem: string;
  inputLabObsidianVersion: string;
  inputLabWebViewVersion: string;
...
export const DEFAULT_SETTINGS: InkedMarkSettings = {
  penPresets: defaultPenPresets(),
  activePresetId: "math-black",
  ...
  inputLabDeviceModel: "",
  inputLabStylus: "",
  inputLabOperatingSystem: "",
  inputLabObsidianVersion: "",
  inputLabWebViewVersion: "",
...
const SCRIBBLE_CALLOUT: CalloutText = {
  ...
  body:
    "iPadOS “Scribble” intercepts fast Apple Pencil strokes before MathInk Forge " +
...
export class InkedMarkSettingTab extends PluginSettingTab {
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Input Lab device model",
            desc: "Exact Huawei tablet model included in exported fixtures.",
            control: {
              type: "text",
              key: "inputLabDeviceModel",
              placeholder: "e.g. MatePad Pro 11",
            },
          },
          {
            name: "Input Lab stylus",
            desc: "Exact M-Pencil generation included in exported fixtures.",
            control: {
              type: "text",
              key: "inputLabStylus",
              placeholder: "e.g. M-Pencil 3rd generation",
            },
          },
          {
            name: "Input Lab operating system",
            desc: "HarmonyOS version included in exported fixtures.",
            control: {
              type: "text",
              key: "inputLabOperatingSystem",
              placeholder: "e.g. HarmonyOS 4.2",
            },
          },
          {
            name: "Input Lab Obsidian version",
            desc: "Installed Obsidian version on the test tablet.",
            control: { type: "text", key: "inputLabObsidianVersion", placeholder: "e.g. 1.x.y" },
          },
          {
            name: "Input Lab WebView version",
            desc: "Android System WebView/Chromium version when known.",
            control: {
              type: "text",
              key: "inputLabWebViewVersion",
              placeholder: "e.g. Chromium 140.x",
            },
          },
          {
            name: "",
  ...
  private renderLegacy(): void {
    ...
    for (const [key, name, desc, placeholder] of [
      [
        "inputLabDeviceModel",
        "Input Lab device model",
        "Exact Huawei tablet model included in exported fixtures.",
        "e.g. MatePad Pro 11",
      ],
      [
        "inputLabStylus",
        "Input Lab stylus",
        "Exact M-Pencil generation included in exported fixtures.",
        "e.g. M-Pencil 3rd generation",
      ],
      [
        "inputLabOperatingSystem",
        "Input Lab operating system",
        "HarmonyOS version included in exported fixtures.",
        "e.g. HarmonyOS 4.2",
      ],
      [
        "inputLabObsidianVersion",
        "Input Lab Obsidian version",
        "Installed Obsidian version on the test tablet.",
        "e.g. 1.x.y",
      ],
      [
        "inputLabWebViewVersion",
        "Input Lab WebView version",
        "Android System WebView/Chromium version when known.",
        "e.g. Chromium 140.x",
      ],
    ] as const) {
      new Setting(containerEl)
